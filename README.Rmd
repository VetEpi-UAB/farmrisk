...
This package provides tools for performing quantitative risk analysis to prioritize farm external biosecurity measures. 

## Installation

You can install the development version of farmrisk from [GitHub](https://github.com/) with:
...
Below is a basic example of how to use the farmrisk package with the farmrisk_cattle() function:
